...
function register(req, res, next) {
    account_service_1.accountService.register(req.body, req.get('origin') || `${req.protocol}://${req.get('host')}`)
...
function forgotPassword(req, res, next) {
    account_service_1.accountService.forgotPassword(req.body, req.get('origin') || `${req.protocol}://${req.get('host')}`)
